# Verifi
A Parameter-Efficient Fine-Tuned model  for High-Precision Financial Reasoning



# 🏦 Verifi: Precision Financial LLM via LoRA
**Bridging the gap between raw financial data and executable numerical reasoning.**
...
## 🎯 Project Objective
General-purpose LLMs often fail at financial "math" hidden within dense reports. **Verifi** addresses this by fine-tuning the model to recognize financial structures and generate precise mathematical programs to answer quantitative queries.
...
* **Infrastructure:** Optimized for execution on a single 24GB VRAM GPU